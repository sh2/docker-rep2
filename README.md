...
以下の現行サーバ上でのDAT落ちの取得を追加しています。
>・DAT落ちした現役サーバに収容されているスレッド
>/板名/oyster/スレッドキー上位4桁の数字/スレッドキー.dat
>例： https://agree.5ch.net/operate/oyster/1684/1684064837.dat

5chの過去ログ倉庫(kako.5ch.net)のスクレイピングに対応しています。
また過去ログ倉庫のスクレイピングを使う場合、新しく追加した2ch_to_5chを「する」にしておいてください。

このあたりの説明はそのうちfukumen/p2-phpのREADME.mdへ移動予定です。

proxy無しのrep2単体でどちらも機能するつもりです。
